...
//help needed for all three animal types
	@Override
	public boolean eats(Animal animal  ) {
   // if bird is against lion , it looses  and it wins against tank		
	// if against the same , it looses
		if (animal instanceof Ruck) {
			return true;
		}
		return false;
	}
